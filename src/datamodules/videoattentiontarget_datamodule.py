...
from src.datamodules.components.VideoAttentionTarget import VideoAttentionTarget
from src.utils import misc


class VideoAttentionTargetDataModule(LightningDataModule):
    def __init__(
        self,
        data_dir: str = "data/",
        batch_size: int = 64,
    ...
    def setup(self, stage: Optional[str] = None):
        ...
        self.data_train = VideoAttentionTarget(
        ...
        self.data_val = VideoAttentionTarget(
            self.hparams.data_dir,
            self.transforms_val,
            is_train=False,
            num_queries=self.hparams.num_queries,
...
if __name__ == "__main__":
    ...
    cfg = omegaconf.OmegaConf.load(
        root / "configs" / "datamodule" / "videoattentiontarget.yaml"
    )
